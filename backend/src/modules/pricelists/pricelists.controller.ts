...
import { CreatePricelistDto, UpdatePricelistDto } from './pricelists.dto';
...
export class PricelistsController {
  ...
  create(@Body() dto: CreatePricelistDto) { return this.svc.create(dto); }

  @Patch(':id') @Roles(Role.SUPER_ADMIN, Role.BRANCH_MANAGER)
  update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdatePricelistDto) { return this.svc.update(id, dto); }
